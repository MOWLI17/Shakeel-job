  ...
  return (
    <section style={{ background: '#131313', minHeight: '100vh', padding: '120px 5%' }}>
      <SEO
        ...
        description="High-quality print designs, brochures, and marketing materials designed by Shakeel Arafath for lasting brand impact."
        keywords="print design, brochure design, marketing materials, graphic design Chennai, Shakeel Arafath"
        url="https://shakeelarafath.in/project/print-design"
        breadcrumb={[
          { name: "Portfolio", url: "https://shakeelarafath.in/#works" },
          { name: "Print Design", url: "https://shakeelarafath.in/project/print-design" }
        ]}
      />
